...
from eemeter.caltrack.daily.utilities.utils_base_model import linear_fit, get_slope, get_intercept, get_T_bnds
...
def fit_c_hdd_tidd(T, obs, settings, opt_options, x0=None, bnds=None, initial_fit=False):
    if initial_fit:
...
def _c_hdd_tidd_weight(c_hdd_bp, c_hdd_beta, intercept, T, residual, sigma=3.0, quantile=0.25, alpha=2.0, min_weight=0.0):
    model_vars = set_full_model_coeffs(c_hdd_bp, c_hdd_beta, intercept)
