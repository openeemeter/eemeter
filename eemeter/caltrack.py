...
def caltrack_predict(
    ...
    if design_matrix.empty:
        ...
        predict_warnings.append(EEMeterWarning(
            qualified_name=(
                'eemeter.caltrack.compute_temperature_features'
            ),
            description=(
        ...
        return ModelPrediction(pd.DataFrame(empty_columns, index=prediction_index),
