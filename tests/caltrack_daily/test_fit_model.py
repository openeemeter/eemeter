...
class TestFitModel:
    ...
    def test_fit_model(self):
        ...
        expected_combinations = ['fw-su_sh_wi', 'fw-sh_wi__fw-su', 'fw-sh_wi__wd-su__we-su', 'wd-su_sh_wi__we-su_sh_wi', 'fw-su__wd-sh_wi__we-sh_wi', 'wd-su__wd-sh_wi__we-su_sh_wi', 'wd-su_sh_wi__we-su__we-sh_wi', 'wd-su__wd-sh_wi__we-su__we-sh_wi']
        ...
        expected_components = ['fw-su', 'wd-su', 'we-su', 'fw-sh_wi', 'wd-sh_wi', 'we-sh_wi', 'fw-su_sh_wi', 'wd-su_sh_wi', 'we-su_sh_wi']
        ...
        expected_model_error = {'wRMSE_train': 16.95324536039207, 'wRMSE_test': np.nan, 'RMSE_train': 16.95324536039207, 'RMSE_test': np.nan, 'MAE_train': 13.38096518529209, 'MAE_test': np.nan}
