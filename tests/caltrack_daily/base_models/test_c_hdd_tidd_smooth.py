...
from eemeter.caltrack.daily.base_models.c_hdd_tidd_smooth import (
    fit_c_hdd_tidd_smooth
)
...
def test_fit_c_hdd_tidd_smooth():
    ...
    settings = Settings(developer_mode = True, alpha_selection=0.1, alpha_final=0.2, segment_minimum_count=5, maximum_slope_OoM_scaler=1)
