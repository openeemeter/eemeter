...
def test_create_caltrack_daily_design_matrix(il_electricity_cdd_hdd_daily):
    ...
    design_matrix = create_caltrack_daily_design_matrix(meter_data[:100], temperature_data)
...
def test_create_caltrack_billing_design_matrix(il_electricity_cdd_hdd_billing_monthly):
    ...
    design_matrix = create_caltrack_billing_design_matrix(meter_data[:10], temperature_data)
