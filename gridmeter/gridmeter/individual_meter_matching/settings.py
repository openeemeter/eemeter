...
class Settings(pydantic.BaseModel):
    ...
    distance_metric: _const.DistanceMetric = pydantic.Field(default=_const.DistanceMetric.EUCLIDEAN, validate_default=True)
    ...
    maximum_distance_threshold: Optional[float] = pydantic.Field(default=None, validate_default=True)
